...
var name = ["Re", "Na", "To"];
var reduceName = name.reduce(function(acumulado, item, index, array){
...
var inversedName = name.reduceRight(function(acumulado, item, index, array){
...
var referenceObject = numberObjects[1]

if ( numberObjects.indexOf(referenceObject) > -1 ) {
...
if ( numberObjects.lastIndexOf(referenceObject, 2) > -1) {
    console.log("Existe um objeto { number: 2 } em numberObjects!");
}else {
    console.log("Não existe um objeto { number: 2 } em numberObjects :(")
}

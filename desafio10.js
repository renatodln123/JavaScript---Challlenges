(function(){
    ...
    */
    ...
    var sum = calcutalor(operationSignalSum);
    var subtraction = calcutalor(operationSignalSubtraction);
    var multiplication = calcutalor(operationSignalMultiplication);
    var division = calcutalor(operationSignalDivision);
    var mod = calcutalor(operationSignalMod);
